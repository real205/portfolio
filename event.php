...
<section class="notice">
  <article class="inner">
    <div class="textbox">
      <h2 data-aos="fade-up" data-aos-duration="800">이벤트 <b class="geomanist">.</b></h2>
      <p data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">XROUTE의 다양한 혜택을 확인해보세요</p>
    </div>
    <div class="noticeTab"> 
      <ul class="noticeTabs" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
        ...
        <li class="current"><a href="event.php?bd=4">이벤트</a></li>
      </ul>

...
<section class="notice">
  <article class="inner">
    <div class="textbox">
      <h2 data-aos="fade-up" data-aos-duration="800">공지사항 <b class="geomanist">.</b></h2>
      <p data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">XROUTE의 공지사항을 확인하세요</p>
    </div>
    <div class="noticeTab"> 
      <ul class="noticeTabs" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
        <li class="current"><a href="notice.php?bd=3">공지사항</a></li>
